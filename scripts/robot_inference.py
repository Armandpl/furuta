...
def parse_args():
    ...
    parser.add_argument('--gym_id', type=str, default="FurutaReal-v0",
    ...
    parser.add_argument('--fs_ctrl', type=int,
                        help='control frequency')
    parser.add_argument('--episode_length', type=int,
                        help='the maximum length of each episode. \
                        -1 = infinite')
    parser.add_argument('--safety_th_lim', type=float,
                        help='Max motor (theta) angle in rad.')
    parser.add_argument('--action_limiter',
                        type=lambda x: bool(strtobool(x)),
                        help='Restrict actions')
    parser.add_argument('--state_limits', type=str,
